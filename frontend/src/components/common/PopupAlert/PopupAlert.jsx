  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <DialogActions>
          <Button className='min-w-[28px] bg-[#1A6FAB] text-white hover:bg-[#1A6FAB]  hover:text-white '
            type={BUTTON_TYPES.SECONDARY} onClick={handleClose}>{cancelTxt}</Button>
          <Button className='min-w-[28px] bg-[#1A6FAB] text-white hover:bg-[#1A6FAB]  hover:text-white ' type="primary" onClick={handleSubmit} autoFocus>
            {submitTxt}
          </Button>
        </DialogActions>
      </Dialog>
