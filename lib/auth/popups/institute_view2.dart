...
class InstituteView2 extends StatefulWidget {
  const InstituteView2({super.key});

  @override
  State<InstituteView2> createState() => _InstituteView2State();
}

class _InstituteView2State extends State<InstituteView2> {
  final codeController = TextEditingController();
  final formKey = GlobalKey<FormState>();
  DashboardController authController = Get.find();
