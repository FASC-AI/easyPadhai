...
class ProfileData {
	...
	ProfileData({this.userDetails, this.classDetail, this.subjectDetail, this.sectionDetail, this.institute, this.picture, this.class1, this.section, this.subject, this.institutionRequired, this.institution});

	ProfileData.fromJson(Map<String, dynamic> json) {
		userDetails = json['userDetails'] != null ? new UserDetails.fromJson(json['userDetails']) : null;
		if (json['classDetail'] != null) {
			classDetail = <ClassDetail>[];
			json['classDetail'].forEach((v) { classDetail!.add(new ClassDetail.fromJson(v)); });
		}
		if (json['subjectDetail'] != null) {
			subjectDetail = <SubjectDetail>[];
			json['subjectDetail'].forEach((v) { subjectDetail!.add(new SubjectDetail.fromJson(v)); });
		}
		if (json['sectionDetail'] != null) {
			sectionDetail = <SectionDetail>[];
			json['sectionDetail'].forEach((v) { sectionDetail!.add(new SectionDetail.fromJson(v)); });
		}
	...
	Map<String, dynamic> toJson() {
      ...
      data['subjectDetail'] = this.subjectDetail!.map((v) => v.toJson()).toList();
    }
		if (this.sectionDetail != null) {
      data['sectionDetail'] = this.sectionDetail!.map((v) => v.toJson()).toList();
    }
